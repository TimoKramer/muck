...
<@layout.page title="Loggers - Muck" activePage="loggers">
        ...
        <div id="htmx-content" class="card bg-base-100 shadow-sm">
            <div class="card-body">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold">Loggers</h2>
                    <div class="flex items-center gap-2">
                        <button class="btn btn-primary btn-sm" onclick="createLoggerModal.showModal()">
