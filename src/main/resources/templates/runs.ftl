...
<@layout.page title="Foobar - Runs - Muck" bobUrl=bobUrl>
                                ...
                                <div class="flex items-center justify-between gap-4">
                                        ...
                                        <div class="text-xs text-base-content/70 space-y-1">
                                            ...
                                            <#if run.initiatedAt?has_content>
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span>Started: ${run.initiatedAt}</span>
                                                </div>
                                            </#if>
                                    ...
                                    <#if run.logger?has_content>
                                        <div class="flex-shrink-0">
                                            <a href="/logs/stream/run/${run.runId}" target="_blank" class="btn btn-primary btn-sm gap-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
