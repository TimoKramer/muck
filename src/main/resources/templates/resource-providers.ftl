...
<@layout.page title="Resource Providers - Muck" activePage="resource-providers">
        ...
        <div id="htmx-content" class="card bg-base-100 shadow-sm">
            <div class="card-body">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-xl font-semibold">Resource Providers</h2>
                    <div class="flex items-center gap-2">
                        <button class="btn btn-primary btn-sm" onclick="createProviderModal.showModal()">
